...
public class KafkaProducer5SyncAndAsyncProducerStringValueExample {

    private static final String BOOTSTRAP_SERVERS = "localhost:9092";
    private static final String PRODUCER_NAME = "KafkaProducerTopicStringExample1-" + UUID.randomUUID();
    ...
    private static void produceSynchronously(Producer<String, String> producer, String producerName, String topicName) {
        ...
        try {
            for (int i = 1; i <= 5; i++) {
                ...
                String value = "Synchronous Message " + i;
    ...
    private static void produceAsynchronously(Producer<String, String> producer, String producerName, String topicName) {
        ...
        for (int i = 1; i <= 5; i++) {
            ...
            String value = "Asynchronous Message " + i;
