...
public class KafkaConsumer3SubscribeTopicPrintAssignPartitionsExample {

    private static final String BOOTSTRAP_SERVERS = "localhost:9092";
    private static final String CONSUMER_GROUP_NAME = "consumer_group_print_assigned_partitions_execution_data_1";
    private static final String CONSUMER_NAME = "KafkaConsumerPrintAssignPartitionsExample-" + UUID.randomUUID();
